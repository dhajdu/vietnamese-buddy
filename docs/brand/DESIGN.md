<!-- source: https://getdesign.md/airbnb/design-md — random auto-pick by /il-project on 2026-09-10 (fetched via npx getdesign@latest add airbnb). Replace when the operator supplies real styling. -->
---
version: alpha
