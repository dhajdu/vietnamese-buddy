...
export default async function PricingPage() {
  ...
  const unavailable = <span className="align-baseline text-base font-normal text-stone">Price unavailable</span>
    ...
    <section className="mx-auto max-w-4xl px-6 py-20">
      ...
      <div className="mt-10 grid items-stretch gap-4 sm:grid-cols-3">
        ...
        <div className="card relative flex flex-col border-2 border-red px-5 py-6">
          ...
          <p className="mt-2 font-vn text-4xl font-extrabold leading-none tracking-[-0.03em] text-ink">
            {monthly != null ? <>${monthly}<span className="align-baseline text-base font-normal text-stone">/mo</span></> : unavailable}
          </p>
          ...
          <div className="mt-6">
            <CheckoutButton term="monthly" label="Subscribe now" live={live} signedIn={false} variant="red" />
          </div>
        </div>
        ...
        <div className="card flex flex-col px-5 py-6">
          ...
          <p className="mt-2 font-vn text-4xl font-extrabold leading-none tracking-[-0.03em] text-ink">
            {annual != null ? <>${annual}<span className="align-baseline text-base font-normal text-stone">/yr</span></> : unavailable}
          </p>
          ...
          <div className="mt-6">
            <CheckoutButton term="annual" label="Subscribe now" live={live} signedIn={false} variant="quiet" />
          </div>
        </div>
      </div>
